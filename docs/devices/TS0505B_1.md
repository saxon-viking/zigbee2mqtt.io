...
Switch the bulb ON (1second) -- OFF (2seconds) --ON (1second) --OFF(2seconds) -- ON. The bulb will now blink slowly like it is breathing. It will breathe for one minute if it fails to connect to the hub. Repeat the procedure if there is a connection failure.
